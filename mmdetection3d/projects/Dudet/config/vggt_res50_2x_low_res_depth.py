...
train_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            dict(type='Resize', scale=(518, 518), keep_ratio=True, interpolation='bicubic'),
        ],
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            ann_file=data_root + 'scannet_infos_train_new.pkl',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'scannet_infos_val_new.pkl',
...
# runtime
find_unused_parameters = False #True  # only 1 of 4 FPN outputs is used
